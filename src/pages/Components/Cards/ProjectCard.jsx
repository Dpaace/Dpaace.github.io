    ...
    return (
        ...
        <>
            <div className='w-full h-10 rounded-t-2xl px-5 bg-coral flex justify-center items-center'>
                <ul className='flex flex-row justify-center text-xl gap-10 text-black'>
                    <li
                        className={`cursor-pointer ${selectedCategory === 'All' ? 'font-bold, text-white' : ''}`}
                        onClick={() => handleCategoryClick('All')}
                    >
                        All
                    </li>
                    <li
                        className={`cursor-pointer ${selectedCategory === 'Web' ? 'font-bold, text-white' : ''}`}
                        onClick={() => handleCategoryClick('Web')}
                    >
                        Web
                    </li>
                    <li
                        className={`cursor-pointer ${selectedCategory === 'AI' ? 'font-bold, text-white' : ''}`}
